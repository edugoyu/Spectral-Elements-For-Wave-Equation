...
# Files
# \texttt{one_d_sem}: Solves the Wave equation in 1-D. 
...
## Plot
* Plotted using python with the file \texttt{plots.py}. Computes the error also between the analytical and the numerical solution.
...
# \texttt{two_d_sem}: Solves the Wave equation in 2-D. 
...
## Plot
* Plotted using python with the file \texttt{plots2d.py}.
* To plot the error we use \texttt{error_plot_2d.py} if we use the initial conditions of which we have the analytical solution.
